...
>
	...
	2017.01.18:开始编写使用指南
	2017.01.19:整理后台代码
	2017.01.20:模块管理功能增加自动创建数据表,至此,可以不用写一句代码就可以完成一个模块的创建
	2017.01.21:DAO层代码优化，尝试解决实体对象中的拓展属性如何设置的问题
	2017.01.22:DAO层增加自动校验对象属性，另外完善DAO层的错误提示
	2017.01.24:SQL层解耦，增加对实体属性的自动处理类
	2017.01.27:Dao层增加基类，抽象出常用通用方法
	2017.01.29:整理注释，准备将所有系统工具封装成类
	2017.02.05:系统工具封装成类，后续继续完善帮助文档
	后续有待实现:全局系统配置，全局审核流
