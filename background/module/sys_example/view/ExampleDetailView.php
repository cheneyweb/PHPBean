...
// 根路径，模块名称，Action名称
import ( '__example', '_exampleDetailView' );
...
class _ExampleDetailView {
	...
	public function execute() {
		...
		$result = $this->_exampleService->queryArr ( $query )[0];
		
		// 使用smarty模版显示结果
		$smarty = $this->smartyUtil->load ();
		$smarty->assign ( 'item', $result );
		$smarty->display ( BASEURL . 'foreground/module/__example/__noprefixexample_detail.html' );
	}
}
?>
